        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="card card-primary">
                  ...
                  <div class="card-body">
                      <input type="text" id="id" class="form-control id" name="id" disabled>
                      <br>
                      <input type="text" id="documento" class="form-control documento" placeholder="Ingresar documento" name="documento">
                      <br>
                      <input type="text" id="nombre" class="form-control nombre" placeholder="Ingresar nombre" name="nombre">
                      <br>
                      <input type="text" id="telefono" class="form-control telefono" placeholder="Ingresar telefono" name="telefono" required>
                      <br>
...
<script src="js/gestorClientes.js"></script>
</body>
</html>
